...
namespace PBIGettingStarted
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string f = @"c:\test\test\ssis\azureTestConn.pbix";//string.Format(@"{0}\AdventureWorks.pbix", di.Parent.Parent.FullName);
            string datasetDisplayName = "table1";
            ...
            //string groupDatasetId = GetDatasets(groupId).value.GetDataset("AdventureWorks").Id;
